...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top navbar-blue">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">Website TH Catering Ibu Tini Hari</a>
        </div>
   ...
   <?php } ?>
	...
	<div class="row">
		<div class="col-md-3">
			<div style="background:#00ACEE; width:100%; height:auto; padding-top:3px;padding-bottom:3px; padding-left:10px;">
			<h4>Kategori Menu</h4>
			</div>
			<ul class="kategori">
				<?php
          $result = $mysqli->query('SELECT * FROM kategori_produk');
        ...
        if($result){
			...
			<div style="background:#00ACEE; width:100%; height:auto; padding-top:3px;padding-bottom:3px; padding-left:10px; 	margin-bottom:15px;">
			...
			<?php
                            if(isset($_SESSION['cart'])){
                                ...
                                echo '<h4 style="color:#212b46;">Rp '. number_format($total, 2, ',', '.') .'</h4>';
                            }else{
                                echo '<h4 style="color:#212b46;">Rp 0,00</h4>';
                            }
